...
class TestModels(unittest.TestCase):
    ...
    def test_launch_model_1(self):
        ...
        with app.test_request_context():
            ...
            launch1 = db.session.query(Launch).filter_by(
                name="testnameLaunch").first()
    ...
    def test_location_model_1(self):
        ...
        with app.test_request_context():
            ...
            location1 = db.session.query(
                Location).filter_by(name="testLoc").first()
    ...
    def test_launch_model_query_1(self):
        ...
        with app.test_request_context():
            launch1 = db.session.query(Launch).filter_by(
                name="Long March 3B | Shijian-13").first()
    ...
    def test_mission_model_link_query_1(self):
        ...
        with app.test_request_context():
            ...
            self.assertEqual(
                agency1.name, "National Aeronautics and Space Administration")
